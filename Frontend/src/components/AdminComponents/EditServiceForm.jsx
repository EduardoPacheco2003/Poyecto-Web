...
const EditServiceForm = ({ service }) => {
  const { nombre, descripcion, costo, disponible, imagen, categoria } = service;
  const categoriaId = categoria.slice(-1);
  ...
  return (
    <div>
      <form className="form margin-y-2" onSubmit={handleSubmit(onSubmit)}>
        {/* Nombre del servicio */}
